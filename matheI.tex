		...
		\section{Konvergenz}\subkeywordNoprint{Konvergenz}{Folgen}
			...
			\subsubsection{Satz 4.6}
				...
				\begin{enumerate}
					...
					\item $\lim\limits_{n\to\infty}(a_n\cdot b_n) = a_* \cdot b_*$
		...
		\section{Rechnen modulo n}
			...
			\subsection{Einheiten und Inverse}
				...
				\subsubsection{Lemma 5.32}
					...
					\begin{align}
						\varphi \left(p^k\right) = p^{k-1} \cdot (p-1)
					\end{align}
					
					\paragraph{Beispiele}
						$\varphi\left(2^3\right) = 2^2 \cdot (2-1) = 4 \cdot 1 = 4$\\
						$\varphi(9) = \varphi\left(3^2\right) = 3^1\cdot (3-1) = 3\cdot 3 = 6$
	...
	\chapter{Lineare Algebra}
		...
		\section{Erzeugendensysteme}
				...
				\subsubsection{Definition 7.4}
					...
					\begin{enumerate}[a)]
						\item Sei $(V, \circleplus, \circlecdot)$ ein $K$-VR, $v_1,\dots,v_n \in V$. Dann heißt $V \in V$ \subkeyword{Linearkombination}{Vektorräume} von $v_1,\dots , v_n$, falls es $s_1,\dots , s_n$ gibt mit
						\begin{align}
