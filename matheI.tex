	...
	\section{Grundlagen und Isomorphismen}
		...
		\section{Matrizen}
			...
			\subsubsection{Definition 8.12}
				...
				\end{align}
				Dann heißt $(a_{ij})_{\scriptsize\begin{array}{l} 1 \leq i \leq m \\ 1 \leq j \leq n \end{array}}$ die \subkeyword{Darstellungsmatrix}{Matrizen} von $f$ bezüglich der Basen $B$ und $P$.
